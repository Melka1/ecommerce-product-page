...
function handleNext(type){
    image++;
    if(image==5) image = 1
    $(`${type} .preview--container img`).attr("src", `./images/image-product-${image}.jpg`)
    ...
    <div class="product--preview">
      ...
      <div class="preview">
        ...
        <div class="preview--container">
            <button class="prev" onclick="handlePrev('aside')">
            ...
            <button class="next" onclick="handleNext('aside')">
